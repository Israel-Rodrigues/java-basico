...
/**
 * Programa para ler três valores e apresentar o menor
 * 
...
public class Exercicio49 {
	...
	public static void main(String[] args) {
		...
		if ((valor1 < valor2) && (valor1 < valor3)) {
			JOptionPane.showMessageDialog(null, valor1 + " é o menor número");
		} else if ((valor2 < valor1) && (valor2 < valor3)) {
			JOptionPane.showMessageDialog(null, valor2 + " é o menor número");
		} else {
			JOptionPane.showMessageDialog(null, valor3 + " é o menor número");
		}
	}
}
